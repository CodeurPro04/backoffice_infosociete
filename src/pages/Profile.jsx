    ...
    <div className="space-y-8">
      <header className="glass-card flex flex-col gap-4 px-6 py-5 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate/60">Informations personnelles et accès.</p>
        </div>
      ...
      <section className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
        ...
        <div className="flex flex-col gap-6">
          <div className="glass-card px-6 py-6">
            <h3 className="font-display text-lg font-semibold text-ink">Sécurité</h3>
            <div className="mt-4 space-y-3 text-sm text-slate/70">
              {['Mot de passe', 'Double authentification', 'Appareils connectés'].map((label) => (
                <div
                  key={label}
          ...
          <div className="glass-card px-6 py-6">
            <h3 className="font-display text-lg font-semibold text-ink">Préférences</h3>
            <p className="mt-2 text-sm text-slate/60">
              Gérez vos accès et préférences personnelles depuis cet espace.
            </p>
